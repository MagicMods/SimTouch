class BaseBoundaryPs {
  constructor({
    ...
    // Visual properties
    this.color = [0.0, 1.0, 0.0, 0.5]; // White, semi-transparent
    this.lineWidth = 0.3;
  ...
  resolveCollision(
    ...
    throw new Error(
      "Method 'resolveCollision' must be implemented by derived class"
    );
  }
  ...
  resolveFLIP(x, y, vx, vy) {
    throw new Error(
      "Method 'resolveFLIP' must be implemented by derived class"
    );
  }

  drawBoundary(gl, shaderManager) {
    throw new Error(
      "Method 'drawBoundary' must be implemented by derived class"
    );
  }

  // Update boundary parameters and notify dependents
  // THIS NEEDS TO BE IMPLEMENTED REWORKED
  update(params) {
    let changed = false;
    if (changed) {
  ...
  getBoundaryType() {
    throw new Error(
      "Method 'getBoundaryType' must be implemented by derived class"
    );
  }
  ...
  getBoundaryDetails() {
    throw new Error(
      "Method 'getBoundaryDetails' must be implemented by derived class"
    );
  }
}

export { BaseBoundaryPs };
