...
class RectangularBoundaryPs extends BaseBoundaryPs {
  constructor({
    centerX = 0.5,
    centerY = 0.5,
    width = 1,
  ...
  resolveCollision(
    ...
    if (!collision && this.boundaryRepulsion > 0) {
      ...
      if (position[0] - minXWithRadius < repulsionZoneX) {
        const strength =
          (1 - (position[0] - minXWithRadius) / repulsionZoneX) *
      ...
      if (maxXWithRadius - position[0] < repulsionZoneX) {
        const strength =
          (1 - (maxXWithRadius - position[0]) / repulsionZoneX) *
          this.boundaryRepulsion;
        velocity[0] -= strength * 0.01;
        collision = true;
      }
      ...
      if (position[1] - minYWithRadius < repulsionZoneY) {
        const strength =
          (1 - (position[1] - minYWithRadius) / repulsionZoneY) *
          this.boundaryRepulsion;
      ...
      if (maxYWithRadius - position[1] < repulsionZoneY) {
        const strength =
          (1 - (maxYWithRadius - position[1]) / repulsionZoneY) *
          this.boundaryRepulsion;
        velocity[1] -= strength * 0.01;
        collision = true;
      }
