...
export class Gradients_LEGACY {
  ...
  applyPreset(presetName) {
    if (!Gradients_LEGACY.PRESETS[presetName]) {
    ...
    this.points = JSON.parse(JSON.stringify(Gradients_LEGACY.PRESETS[presetName]));
    this.update();
  ...
  // Send Gradients_LEGACY update to hardware over WebSocket
  ...
  getPresetNames() {
    return Object.keys(Gradients_LEGACY.PRESETS);
  }
